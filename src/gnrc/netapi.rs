...
unsafe fn gnrc_netapi_dispatch_send(nettype: gnrc_nettype_t, demux_ctx: u32, pkt: *mut gnrc_pktsnip_t) -> i32
{
...
pub fn dispatch_send(nettype: gnrc_nettype_t, demux_ctx: u32, pkt: impl Into<Pktsnip<Shared>>) -> i32 {
